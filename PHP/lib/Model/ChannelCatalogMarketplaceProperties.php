...
class ChannelCatalogMarketplaceProperties implements ArrayAccess
{
    ...
    /**
     * Sets links
     * @param \Swagger\Client\Model\BeezUPCommonLink2[] $links These links contains a way to configure the settings and potentially an Marketplace Authorization Url.
     * @return $this
     */
