...
class ChannelColumn implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'channel_column_name' => 'string',
        'channel_column_description' => 'string',
     ...
     * @param string $channel_column_name The channel column name
     * @return $this
     */
     ...
     * @param string $channel_column_description The channel column description
     * @return $this
     */
     ...
     * @param bool $show_in_mapping Indicates if we have to map this column or not
     * @return $this
     */
