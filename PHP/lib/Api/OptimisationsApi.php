...
class OptimisationsApi
{
     ...
     *
     * @param string $store_id Your store identifier (required)
     * @param string $category_id The category identifier concerned by this optimisation (required)
     * @param string $action_name  (required)
     * @param string[] $request The channel identifier list concerned by this optimisation (optional)
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @return void
     */
    public function optimiseByCategory($store_id, $category_id, $action_name, $request = null)
    {
        list($response) = $this->optimiseByCategoryWithHttpInfo($store_id, $category_id, $action_name, $request);
        return $response;
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function optimiseByCategoryWithHttpInfo($store_id, $category_id, $action_name, $request = null)
    {
        // verify the required parameter 'store_id' is set
        if ($store_id === null) {
        ...
        if ($category_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $category_id when calling optimiseByCategory');
        }
        // verify the required parameter 'action_name' is set
        if ($action_name === null) {
        ...
        // parse inputs
        $resourcePath = "/v2/user/analytics/{storeId}/optimisations/bycategory/{categoryId}/{actionName}";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
