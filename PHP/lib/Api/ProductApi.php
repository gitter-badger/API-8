...
class ProductApi
{
    ...
    /**
     * Operation getChannelCatalogProduct
     *
     ...
     */
    public function getChannelCatalogProduct($channel_catalog_id, $product_id)
    {
        list($response) = $this->getChannelCatalogProductWithHttpInfo($channel_catalog_id, $product_id);
        return $response;
    }

    /**
     * Operation getChannelCatalogProductWithHttpInfo
     *
     * Get channel catalog product information
     *
     * @param string $channel_catalog_id The channel catalog identifier (required)
     ...
     */
    public function getChannelCatalogProductWithHttpInfo($channel_catalog_id, $product_id)
    {
        // verify the required parameter 'channel_catalog_id' is set
        if ($channel_catalog_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $channel_catalog_id when calling getChannelCatalogProduct');
        }
        // verify the required parameter 'product_id' is set
        if ($product_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $product_id when calling getChannelCatalogProduct');
        }
        // parse inputs
