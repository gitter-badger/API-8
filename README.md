...
6. If you did everything correct, https://beezup.github.io/API/ will lead to your new docs
...
- Documentation(ReDoc): https://beezup.github.io/API/
- SwaggerUI: https://beezup.github.io/API/swagger-ui/
- Look full spec:
    + JSON https://beezup.github.io/API/swagger.json
    + YAML https://beezup.github.io/API/swagger.yaml
- Preview spec version for branch `[branch]`: https://beezup.github.io/API/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://beezup.github.io/API/ with url from the message: `Server started <url>`
